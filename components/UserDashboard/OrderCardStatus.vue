<template>
  <div>
    <h4 class="mb-3 flex gap-2 items-center" :class="statusColors[props.order]">
      <svg
        v-if="props.order == 'pending'"
      ...
      <svg
        v-else-if="props.order == 'processing'"
        xmlns="http://www.w3.org/2000/svg"
        width="2em"
        height="2em"
      ...
      <svg
        v-else-if="props.order == 'delivered'"
        xmlns="http://www.w3.org/2000/svg"
        width="2em"
        height="2em"
        viewBox="0 0 16 16"
      ...
      <svg
        v-else-if="props.order == 'canceled'"
        xmlns="http://www.w3.org/2000/svg"
        width="30"
        height="30"
        viewBox="0 0 24 24"
      ...
      <span v-text="statusTexts[props.order]"></span>
    </h4>
  </div>
</template>
