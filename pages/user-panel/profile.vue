    ...
    <form @submit.prevent="editUserProfile">
      ...
      <div class="mt-4">
        ...
        <input
          ...
          class="file-input file-input-ghost w-full border border-purple-c bg-white dark:bg-dark-s"
        />
      </div>
      <button class="btn-c w-full mt-5 h-12" v-if="!loading">ویرایش اطلاعات</button>
